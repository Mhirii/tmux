...
# The theme to use.
export TMUX_POWERLINE_THEME="nero"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_USERNAME="ahmedmhriri218"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/mhiri/.mail/inbox/new"

## mbox
# Path to the mbox to check.
export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/mhiri"

## mailcheck
# Optional path to mailcheckrc
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/mhiri/.mailcheckrc"
# }
